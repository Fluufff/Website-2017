$(document).ready(function(){
	...
	function addFilters(){
		if($('#attendee-filters').length > 0){
		    ...
		    $('#attendee-filters').html('<select id="countrySorter" style="margin:20px 0;display:block;">' + options + '</select>');
		    ...
		    $('#attendee-filters').append(''
				+ '<input type="checkbox" id="fursuiterOnly">'
				+ '&nbsp;'
				+ '<label for="fursuiterOnly" style="padding:15px;">Fursuiters</label>'
		    );
		    ...
		    //sponsor
		    $('#attendee-filters').append(''
				+ '<input type="checkbox" id="sponsorOnly">'
				+ '&nbsp;'
				+ '<label for="sponsorOnly" style="padding:0 15px;">Sponsor</label>'
		    );
		    ...
		    //count init
		    $('#attendee-filters').append('<br>Total: <span id="filterTotal"></span>');
